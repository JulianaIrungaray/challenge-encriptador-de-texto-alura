const d = document,
    ...
    $encriptadoContainer = d.querySelector(".container-txt-encrip");
...
$btnDescifrar.addEventListener("click", (e) => {
  const $encriptadoContainer = d.querySelector(".container-txt-encrip");
...
$encriptadoContainer.addEventListener("click", (e) => {
  ...
  if (e.target.matches(".copy-btn")) {
    ...
    $copyButton.textContent = "Mira a tu izquierda";
